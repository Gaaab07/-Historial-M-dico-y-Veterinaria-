...
namespace COMPLETE_FLAT_UI
{
    public partial class FormMenuPrincipal : Form
    {
        ...
        {
            FormListaPaciente fm = new FormListaPaciente();
            ...
            {
                // Cadena de conexión
                using (SqlConnection conexionn = new SqlConnection("Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=BD_HM;Data Source=DESKTOP-HTCT9FE"))
                {
        ...
        {
            FromEnfermero frm = new FromEnfermero();
